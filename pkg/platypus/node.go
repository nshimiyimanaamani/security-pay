...
// func (n *node) traverse(keys []string, params *Params, paramIndex int) (*node, string) {
// 	if paramIndex >= len(keys) {
// 		return n, ""
// 	}
...
// 				if nextParamIndex < len(keys) {
// 					return child.traverse(keys, params, nextParamIndex)
// 				}
// 				return child, key
// 			}
// 		}
