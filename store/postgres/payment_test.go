...
// 			tx:   payment.Payment{ID: id, Code: property.ID, Amount: invoice.Amount, Invoice: invoice.ID, Method: method},
// 			err:  nil,
// 		},
// 		{
...
// 			tx:   payment.Payment{ID: "invalid", Code: property.ID, Amount: invoice.Amount, Invoice: invoice.ID, Method: method},
