        ...
        table: {
          ...
          body: [
            ...
            [
              ...
              { text: user.owner.phone, style: "tableData" }
            ],
            [
              { text: "House ID", style: "tableHeader" },
            ...
            [
              { text: "For Rent", style: "tableHeader" },
              { text: user.occupied ? "Yes" : "No", style: "tableData" }
            ],
            [
              { text: "Registered by", style: "tableHeader" },
              { text: user.recorded_by, style: "tableData" }
            ],
            [
              { text: "Registered on", style: "tableHeader" },
              {
...
function BodyData(items) {
  ...
  items.map(item => {
    data.push([
      ...
      { text: item.status, style: "tableData" }
    ]);
  });
  return data;
}
